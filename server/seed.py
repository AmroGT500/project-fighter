...
def create_mock_data():
    with app.app_context():
        ...
        fighter1 = Fighter(name='Cell', image='https://i.imgur.com/EajHyQY.png', hp=200, ap=18, sprite_pose='', sprite_punch='', sprite_kick='', sprite_block='')
        fighter2 = Fighter(name='Frieza', image='https://i.imgur.com/ijy3OdR.png', hp=180, ap=20, sprite_pose='', sprite_punch='', sprite_kick='', sprite_block='')
        fighter3 = Fighter(name='Goku', image='https://i.imgur.com/bX7SWvp.png', hp=200, ap=25, sprite_pose='', sprite_punch='', sprite_kick='', sprite_block='') 
        fighter4 = Fighter(name='Kid Buu', image='https://i.imgur.com/eNO6RfM.png', hp=170, ap=30, sprite_pose='', sprite_punch='', sprite_kick='', sprite_block='')
        fighter5 = Fighter(name='Piccolo', image='https://i.imgur.com/qPtuqPy.png', hp=175, ap=22, sprite_pose='', sprite_punch='', sprite_kick='', sprite_block='')
        fighter6 = Fighter(name='Vegeta', image='https://i.imgur.com/apPD4jT.png', hp=195, ap=26, sprite_pose='', sprite_punch='', sprite_kick='', sprite_block='')
        ...
        match12 = Match(win_loss=True, user=user1, fighter1_id=fighter6.id, fighter2_id=fighter5.id)
