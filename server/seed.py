...
def create_mock_data():
    with app.app_context():
        ...
        fighter1 = Fighter(name='Android 18', image='https://i.imgur.com/jX78L4Q.png', hp=200, ap=15)
        fighter2 = Fighter(name='Bardock', image='https://i.imgur.com/fMbivmS.png', hp=190, ap=18)
        fighter3 = Fighter(name='Broly', image='https://i.imgur.com/yQKzEzw.png', hp=230, ap=15)
        fighter4 = Fighter(name='Cell', image='https://i.imgur.com/nhqyfnx.png', hp=200, ap=18)
        fighter5 = Fighter(name='Frieza', image='https://i.imgur.com/hgIH62t.png', hp=180, ap=20)
        fighter6 = Fighter(name='Future Trunks', image='https://i.imgur.com/icO4kUp.png', hp=175, ap=22)
        fighter7 = Fighter(name='Goku', image='https://i.imgur.com/OvgUPKU.png', hp=200, ap=25)
        fighter8 = Fighter(name='Kid Buu', image='https://i.imgur.com/RVAk8qj.png', hp=170, ap=30)
        fighter9 = Fighter(name='Krillin', image='https://i.imgur.com/o1U70Nc.png', hp=165, ap=18)
        fighter10 = Fighter(name='Piccolo', image='https://i.imgur.com/ffXBE7o.png', hp=175, ap=22)
        fighter11 = Fighter(name='Teen Gohan', image='https://i.imgur.com/X8uKthE.png', hp=190, ap=27)
        fighter12 = Fighter(name='Vegeta', image='https://i.imgur.com/sPcDv04.png', hp=195, ap=26)
